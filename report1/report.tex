...
\begin{document}
    ...
    \section{Przybliżenie liczby PI metodą Monte Carlo}
        ...
        Na podstawie otrzymanych wcześniej pomiarów czasu wykonania programu, przygotowałem wykres przyśpieszenia w zależności od liczby procesorów dla problemów o różnym rozmiarze. Przyśpieszenie obliczyłem jako stosunek czasu wykonania programu dla 
        
        \begin{center}
            \includegraphics[width=13cm]{report1/images/ex2_vcl_speedup.png}
        \end{center}
        
        % Zauważyć możemy, że dla problemów  o dużym rozmiarze linia przybliża się do teoretycznie idealnej postaci y=x.
